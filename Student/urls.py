...
from .views import  evaluate_course, student_evaluation_reports, studenthomepage , Register , Studnets , student_evaluate_page
urlpatterns = [
...
path('student-evaluation-reports/', student_evaluation_reports, name='student_evaluation_reports'),
]
