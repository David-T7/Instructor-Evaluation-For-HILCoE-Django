...
from .views import  evaluate_course, moreStudentEvaluationDetails, search_evaluation, student_evaluation_reports, studenthomepage , Register , Studnets , student_evaluate_page , total_evaluation_reports
urlpatterns = [
